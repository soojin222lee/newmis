...
// AI GUIDE: 월 마감 및 ERP 전송 결과 조회 화면입니다.
// - 프로젝트별 월마감 대상, 월별 수행비용, ERP 실적 반영 결과를 조회합니다.
// - 기준월 이전 실적과 이후 계획을 비교해 마감/정산 관점의 이상 여부를 확인하는 컨셉입니다.
// - AI 화면 가이드는 마감월, ERP 전송 상태, 비용영역별 실적/계획 차이를 중심으로 설명해야 합니다.
